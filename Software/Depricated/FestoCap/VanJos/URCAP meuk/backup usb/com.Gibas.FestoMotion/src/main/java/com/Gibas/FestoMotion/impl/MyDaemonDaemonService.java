...
public class MyDaemonDaemonService implements DaemonService {
	...
	public void init(DaemonContribution daemonContribution) {
		...
		try {
			daemonContribution.installResource(new URL("file:com/Gibas/FestoMotion/impl/daemon/"));
	...
	public URL getExecutable() {
		try {
			...
			return new URL("file:com/Gibas/FestoMotion/impl/daemon//hello-world.py"); // Python executable
