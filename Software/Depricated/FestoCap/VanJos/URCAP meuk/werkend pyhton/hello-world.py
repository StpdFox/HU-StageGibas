...
#misschien losse functies voor de check bits doen. voor overzichtelijkheid en reproduceerbaarheid. mogelijk bitshiften weergeven
delaytimer = 0.5
...
def enable():
    ...
    while (status[0] & 256 != 256): #256 is een mask om 0000 1000 0000 te vergelijken met de status
        status = statusMsg  # get new status
