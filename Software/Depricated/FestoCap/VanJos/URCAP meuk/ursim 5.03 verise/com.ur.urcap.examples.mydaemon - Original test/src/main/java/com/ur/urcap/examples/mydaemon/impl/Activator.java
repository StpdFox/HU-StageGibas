...
public class Activator implements BundleActivator {
	...
	public void start(final BundleContext context) throws Exception {
		...
		context.registerService(ProgramNodeService.class, new WaitProgramNodeService(), null);
		context.registerService(ProgramNodeService.class, new PositionProgramNodeService(), null);
        context.registerService(ProgramNodeService.class, new HomingProgramNodeService(), null);
